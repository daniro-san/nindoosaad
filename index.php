  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#btnSearch').on('click', function(e) {
        ...
        urls.push({url: 'https://40.76.88.50:5015/tj_sp2?nome_razao='+empresa+'&documento='+cnpj+'&modelo=58&tipo=cnpj', name: 'TJ SP - CERTIDÃO DE FALÊNCIAS, CONCORDATAS', id: 'tj_sp', uf: ['SP']});
