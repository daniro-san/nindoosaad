  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#btnSearch').on('click', function(e) {
        ...
        urls.push({url: 'https://40.76.88.50:5002/cnd_municipal_sp?documento='+cnpj+'&certidao=2', name: 'CND MUNICIPAL (CERTIDÃO IPTU)', id: 'cnd_municipal'});
        urls.push({url: 'https://40.76.88.50:5002/cnd_municipal_sp?documento='+cnpj+'&certidao=1', name: 'CND MUNICIPAL (CERTIDÃO MOBILIÁRIA)', id: 'cnd_municipal'});
